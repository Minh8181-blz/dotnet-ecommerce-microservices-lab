...
namespace API.Identity.Migrations.Ids4ConfigurationGrantContext
{
    public partial class AddIds4Persisted : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.EnsureSchema(
                name: "ms_identity__ids_conf");

            migrationBuilder.CreateTable(
                name: "ApiResources",
                schema: "ms_identity__ids_conf",
                columns: table => new
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalSchema: "ms_identity__ids_conf",
