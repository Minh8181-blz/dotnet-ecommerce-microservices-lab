...
namespace API.Catalog.BackgroundServices
{
    public class IntegrationRetryBackgroundService : BackgroundService
    {
        ...
        public ILogger<IntegrationRetryBackgroundService> Logger => _logger;
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                _context = scope.ServiceProvider.GetRequiredService<CatalogContext>();
